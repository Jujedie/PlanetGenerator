class_name PGCartographicPalette
extends RefCounted

const DEFAULT_PATH := "res://addons/planet_generator/runtime/data/cartography/default_palette.json"
...
static func load_palette(path: String = DEFAULT_PATH) -> PGCartographicPalette:
	var palette := PGCartographicPalette.new()
