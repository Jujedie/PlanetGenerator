...
var BIOMES = [
	...
	Biome.new("Taïga (forêt boréale)", Color.hex(0x476b3eFF), Color.hex(0x3a4d38FF), [-10, 10], [0.0, 1.0], [-ALTITUDE_MAX, ALTITUDE_MAX], false),
	...
	#	Biomes terrestres
	Biome.new("Désert de sel", Color.hex(0xd9cba0FF), Color.hex(0xc4b893FF), [-273, 50], [0.0, 0.35], [-ALTITUDE_MAX, ALTITUDE_MAX], false, [4]),
