...
var BIOMES = [
	...
	Biome.new("Calotte Glaciaire", Color.hex(0xe8f0ffFF), Color.hex(0xe0e8f0FF), [-90, -5], [0.10, 1.0], [-ALTITUDE_MAX, ALTITUDE_MAX], false, [TYPE_TERRAN]),
	Biome.new("Désert Polaire", Color.hex(0xc8d8f0FF), Color.hex(0xb8c8d8FF), [-90, 0], [0.0, 0.15], [0, ALTITUDE_MAX], false, [TYPE_TERRAN]),
	Biome.new("Toundra", Color.hex(0xa0b080FF), Color.hex(0x6a7858FF), [-15, 10], [0.10, 0.45], [0, 2500], false, [TYPE_TERRAN]),
	Biome.new("Toundra Alpine", Color.hex(0x909898FF), Color.hex(0x707878FF), [-30, 15], [0.0, 1.0], [2500, ALTITUDE_MAX], false, [TYPE_TERRAN]),
	Biome.new("Taïga (Forêt Boréale)", Color.hex(0x205830FF), Color.hex(0x1a3820FF), [-10, 15], [0.25, 0.65], [0, 2500], false, [TYPE_TERRAN]),
	Biome.new("Prairie Alpine (Alpage)", Color.hex(0x90c050FF), Color.hex(0x608838FF), [-5, 18], [0.35, 0.75], [1500, 3500], false, [TYPE_TERRAN]),
	Biome.new("Forêt de montagne", Color.hex(0x388030FF), Color.hex(0x284828FF), [-10, 22], [0.25, 0.80], [800, ALTITUDE_MAX], false, [TYPE_TERRAN]),

	# --- TERRES : CLIMATS TEMPÉRÉS ---
	Biome.new("Forêt Tempérée (Décidue)", Color.hex(0x30a030FF), Color.hex(0x2a6028FF), [5, 22], [0.35, 0.70], [0, 2000], false, [TYPE_TERRAN]),
	Biome.new("Forêt de Séquoias", Color.hex(0x487038FF), Color.hex(0x304830FF), [8, 22], [0.55, 0.85], [0, 1500], false, [TYPE_TERRAN]),
	Biome.new("Forêt Humide (Rainforest)", Color.hex(0x006820FF), Color.hex(0x184818FF), [5, 30], [0.65, 1.0], [0, 2000], false, [TYPE_TERRAN]),
	Biome.new("Prairie Verdoyante", Color.hex(0x80d040FF), Color.hex(0x58a038FF), [10, 25], [0.35, 0.55], [0, 1000], false, [TYPE_TERRAN]),
	Biome.new("Maquis Méditerranéen", Color.hex(0xa0a040FF), Color.hex(0x687040FF), [14, 35], [0.10, 0.35], [0, 1500], false, [TYPE_TERRAN]),
	Biome.new("Steppes sèches", Color.hex(0xc8b080FF), Color.hex(0x988858FF), [5, 35], [0.05, 0.25], [0, 2500], false, [TYPE_TERRAN]),
	Biome.new("Steppes tempérées", Color.hex(0xb8a870FF), Color.hex(0x908050FF), [-5, 25], [0.10, 0.30], [0, 2500], false, [TYPE_TERRAN]),
	Biome.new("Marécage Tempéré", Color.hex(0x508040FF), Color.hex(0x384830FF), [5, 30], [0.70, 1.0], [0, 200], true, [TYPE_TERRAN], true),
