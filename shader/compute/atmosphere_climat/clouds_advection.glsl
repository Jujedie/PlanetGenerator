...
// ============================================================================
// CLOUDS ADVECTION SHADER - Étape 3.3b : Transport Semi-Lagrangien (SIMPLIFIÉ)
// ============================================================================
// Transport basique de la vapeur via advection semi-lagrangienne.
...
void main() {
    ...
    // Tracer en arrière pour trouver d'où vient la vapeur
    vec2 pos = vec2(pixel) + 0.5;
    vec2 prev_pos = pos - wind * params.dt;
    
    // Échantillonner la vapeur à la position précédente
    float advected_vapor = bilinearSample(prev_pos);
    
    // === DISSIPATION ===
    // Légère perte pour stabilité
